...
class BotMsg(Enum):
    ...
    MenuDescription = f"Для вас предоставлено командное меню: \n" \
                      f"/start - начать игру.\n" \
                      f"/stop - прервать игру. Доступно только для создателя игровой сессии.\n" 

    GameRulesOne = f"Правила игры: \n" \
                f"1. Кто готов учавствовать - жми 'Я участвую!' \n" \
                f"2. В игре может принимать участие до 6-ти игроков, включая создателя игровой сессии. Если участников " \
                ...
                f"по истечению 1 минуты, капитан команды выбирает игрока, который даст ответ на заданный вопрос!(Все ответы должны быть односложными)\n "    
